import { FastFood, FoodGroupEnum, Kashrut } from "../Interfaces/Fast.Food.Interface"
...
export const api = {
    ...
    searchFoodByValues: async (values: SearchValuesModel) => items
        .filter(m => (m.fats < values.fatMax) &&
